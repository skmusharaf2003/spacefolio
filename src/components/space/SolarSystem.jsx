...
const SolarSystem = ({ onPlanetFocus }) => {
    ...
    const handleSunHover = (isHovering) => {
        setShowResumePrompt(!isHovering);
    };

    const handleSunTouch = () => {
        setShowResumePrompt((prev) => !prev);
    };
                ...
                >
                    ...
                    >
                        <button
                            ...
                            onMouseEnter={() => handleSunHover(true)}
                            onMouseLeave={() => handleSunHover(false)}
                            onTouchStart={handleSunTouch}
